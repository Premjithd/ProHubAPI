...
namespace ServiceProviderAPI.Migrations
{
    ...
    [Migration("20260111000001_AddAddressFieldsToPro")]
    partial class AddAddressFieldsToPro
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceProviderAPI.Models.ProUser", b =>
                {
                    b.HasOne("ServiceProviderAPI.Models.Pro", null)
                        .WithMany()
                        .HasForeignKey("ProId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ServiceProviderAPI.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
